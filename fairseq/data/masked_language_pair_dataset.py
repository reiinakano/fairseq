...
class MaskedLanguagePairDataset(FairseqDataset):
    """
    A trio of torch.utils.data.Datasets. Source dataset, target dataset, and target dataset with mask
    ...
    Args:
        ...
        mask (torch.utils.data.Dataset): dataset containing padded symbols as mask
    ...
    def __init__(
        ...
        tgt=None, tgt_sizes=None, tgt_dict=None, mask=None,
    ...
    def __getitem__(self, index):
        ...
        mask_item = self.mask[index] if self.mask is not None else None
